...
![Platelet Ca²⁺ pathway, v0.4.1. Agonist → receptors → Gαq → PLCβ → IP3 → IP3R → Ca²⁺_cyt, with buffering, SOCE refill, mito shuttle, and extrusion.](../figures/model-status-graphviz.png)
...
![Free vs. bound Ca²⁺ over a 240 s IP3-driven transient. Cyt rises from ~100 nM to ~500 nM and recovers; DTS depletes and refills via SOCE; buffer occupancy shifts visibly during the peak.](../figures/ca-bound-free-v0.4.0.png)
