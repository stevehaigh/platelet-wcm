...
![**The v0.7 platelet Ca²⁺ signalling network.** Plasma-membrane receptors split into a **Gq/P2Y1 arm** (green) and a **Gi/P2Y12 arm** (purple) feeding the cytosolic Ca²⁺ machinery; **PKC** is the activation hub, driving three terminal outputs.](../figures/v0.7-platelet-ca-pathway.png){#fig-pathway width=100%}
