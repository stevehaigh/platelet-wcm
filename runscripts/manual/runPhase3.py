...
def _run_one_condition(condition_dir: str, label: str, length_sec: int,
	...
	Phase 3 always uses the default agonist stimulation (the spike is the
	stimulus we're testing the SOCE-shape response to); the comparison is
	over extracellular Ca²⁺ only.
	"""
